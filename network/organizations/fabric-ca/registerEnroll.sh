...
function createKementrian() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7054 --caname ca-kementrian --tls.certfiles "${PWD}/organizations/fabric-ca/kementrian/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7054-ca-kementrian.pem
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca-kementrian -M "${PWD}/organizations/peerOrganizations/kementrian.example.com/peers/peer0.kementrian.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/kementrian/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca-kementrian -M "${PWD}/organizations/peerOrganizations/kementrian.example.com/peers/peer0.kementrian.example.com/tls" --enrollment.profile tls --csr.hosts peer0.kementrian.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/kementrian/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:7054 --caname ca-kementrian -M "${PWD}/organizations/peerOrganizations/kementrian.example.com/users/User1@kementrian.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/kementrian/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://kementrianadmin:kementrianadminpw@localhost:7054 --caname ca-kementrian -M "${PWD}/organizations/peerOrganizations/kementrian.example.com/users/Admin@kementrian.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/kementrian/ca-cert.pem"
  { set +x; } 2>/dev/null
