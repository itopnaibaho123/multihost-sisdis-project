...
function networkCAUpHost1() {
  ...
  println "###########################################################################"
  infoln "Generating CCP files for badanpertanahannasional"
  organizations/ccp-generate-badanpertanahannasional.sh
  println ""
...
function networkDown() {
  ...
  COMPOSE_FILES="-f compose/docker-compose-orderer.yaml -f compose/docker-compose-badanpertanahannasional.yaml -f compose/docker-compose-user.yaml -f compose/docker-compose-ca.yaml"
  COMPOSE_FILES=" $COMPOSE_FILES -f compose/docker-compose-host1-ca.yaml -f compose/docker-compose-host1-badanpertanahannasional.yaml -f compose/docker-compose-host1-orderer.yaml"
