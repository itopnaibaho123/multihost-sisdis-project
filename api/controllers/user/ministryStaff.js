...
const getById = async (req, res) => {
    try {
        ...
        const result = await ministryStaffService.getById(req.params.ministryStaffId);
...
const update = async (req, res) => {
    try {
        ...
        const result = await ministryStaffService.update(req.params.ministryStaffId, req.body);
